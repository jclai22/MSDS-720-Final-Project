...
\title{Detecting Bot-Like Behavior in Spotify User Data: A Literature Review}

\author{
Jaclyn Claiborne\textsuperscript{1} \and Tenicka Norwood\textsuperscript{1} \\[6pt]
\textsuperscript{1}School of Applied Computational Sciences, Meharry Medical College \\
Nashville, TN 37208, USA \\
\texttt{jaclyn.claiborne@mmc.edu} \\
\texttt{tenicka.norwood@mmc.edu}
}
